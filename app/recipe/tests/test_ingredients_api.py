...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients_list(self):
        ...
        ingrredients = Ingredient.objects.all().order_by('-name')
        serializer = IngredientSerializer(ingrredients, many=True)
    ...
    def test_create_ingredient_invalid(self):
        """test ingredient creation fails"""
        payload = {'name': ''}
